...
import * as animationData from './img/no-found.json';
	...
	return (
		<main className="flex  bg-ghost min-h-screen flex-col items-center p-6 drop-shadow-lg ">
			{searchObj.tags.size !== 0 ? (
				<div className=" mt-2 bg-base-100 rounded-md flex justify-center items-center drop-shadow-lg min-w-full min-h-7">
			...
			lectureContext.lectures.length === 0 ? (
				<div className="">
					...
					<h1 className='text-center text-xl font-black sm:text-4xl'>מצטערים לא מצאנו את המרצה המתאים בשבילך 🙄</h1>
				</div>
			) : (
